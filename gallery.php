...
<body>
 ...
 <div class="container-fluid p-0   " style="background:rgba(0, 0, 0, .4);">
         <div class="row " style="padding-top: 0px;">
            <div class="col-lg-12 text-center my-2 ">
                <h4 class="mt-100">Our Best Watchs</h4>
            </div>
         </div>
         <div class="portfolio-menu mt-200 mb-4">
            <ul>
               <li class="btn btn-outline-dark active" data-filter="*">All</li>
               <li class="btn btn-outline-dark" data-filter=".gts">Luxury Watch</li>
               <li class="btn btn-outline-dark" data-filter=".lap">Simple Watch</li>
               <li class="btn btn-outline-dark text" data-filter=".selfie">Latest Watch</li>
            </ul>
         </div>
         <div class="portfolio-item row">
            ...
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g4.jpg" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
            ...
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g6.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g7.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g8.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g9.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g10.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g1.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g2.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/g3.jpg" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
            ...
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/w1.webp" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
            ...
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/w2.webp" alt="">
               </a>
            </div>
            <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/w3.webp" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/w3.jpg" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/w4.webp" alt="">
               </a>
            </div>
            <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/wf1.webp" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
               ...
               <img class="img-fluid" src="image/wf2.webp" alt="">
               </a>
            </div>
            <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
